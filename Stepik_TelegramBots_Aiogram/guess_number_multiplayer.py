...
# Этот хэндлер будет срабатывать на команду "/quit"
@dp.message(Command(commands='quit'))
...
# В качестве фильтра может выступать любая функция, возвращающая True или False
@dp.message(F.text.lower().in_(['да', 'давай', 'сыграем', 'игра',
                                'играть', 'хочу играть', 'ага', 'хорошо']))
